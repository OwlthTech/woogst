                                    ...
                                    if ($role_slug != 'administrator'):
                                          ...
                                          <tr>
                                                <td data-label="<?php esc_html_e('Role', 'woogst'); ?>">
                                                      <?php echo esc_html($role_details['name']); ?></td>
                                                <td data-label="<?php esc_html_e('Manage Woogst Settings', 'woogst'); ?>">
                                                      <input type="hidden"
                                                            name="manage_woogst_settings[<?php echo esc_attr($role_slug); ?>]"
                                                            value="0" />
                                                      <input type="checkbox"
                                                            name="manage_woogst_settings[<?php echo esc_attr($role_slug); ?>]" value="1"
                                                ...
                                                <td data-label="<?php esc_html_e('Edit GST Reports', 'woogst'); ?>">
                                                      <input type="hidden" name="edit_gst_reports[<?php echo esc_attr($role_slug); ?>]"
                                                            value="0" />
                                                      <input type="checkbox"
                                                            name="edit_gst_reports[<?php echo esc_attr($role_slug); ?>]" value="1" <?php checked($role->has_cap('edit_gst_reports'), true); ?> />
                                                </td>
                                                <td data-label="<?php esc_html_e('Create GST Reports', 'woogst'); ?>">
                                                      <input type="hidden" name="publish_gst_reports[<?php echo esc_attr($role_slug); ?>]"
                                                            value="0" />
                                                      <input type="checkbox"
                                                            name="publish_gst_reports[<?php echo esc_attr($role_slug); ?>]" value="1" <?php checked($role->has_cap('publish_gst_reports'), true); ?> />
                                                </td>
                                                <td data-label="<?php esc_html_e('Edit Order Reports', 'woogst'); ?>">
                                                      <input type="hidden" name="delete_gst_reports[<?php echo esc_attr($role_slug); ?>]"
                                                            value="0" />
                                                      <input type="checkbox"
                                                            name="delete_gst_reports[<?php echo esc_attr($role_slug); ?>]" value="1" <?php checked($role->has_cap('delete_gst_reports'), true); ?> />
                                                </td>
                                          </tr>
                                          <?php
                                    endif;
